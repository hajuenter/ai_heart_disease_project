...
import { predictHeartDiseaseSimple } from "../services/heartSimpleService";
import { Heart, Loader2, RotateCcw, Info } from "lucide-react";
import toast, { Toaster } from "react-hot-toast";
import { useNavigate } from "react-router-dom";

export default function ExpertSystemSimple() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const data = await predictHeartDiseaseSimple(form);
  ...
  return (
    <div className="min-h-screen px-6 py-12 overflow-x-hidden flex flex-col items-center bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="w-full max-w-6xl bg-white dark:bg-gray-900 shadow-lg rounded-2xl p-6 lg:p-12">
        <div className="text-center mb-8 flex flex-col items-center gap-6">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 dark:text-white">
            Sistem Pakar Simple <br className="hidden sm:block" />
            <span className="text-blue-600 dark:text-yellow-400">
              Penyakit Jantung
            </span>
          </h1>
          <div className="mt-3 px-6 py-4 rounded-xl font-semibold text-sm text-center bg-red-100 text-red-700 dark:bg-red-900/40 dark:text-red-300 max-w-3xl mx-auto">
